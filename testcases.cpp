#include <iostream>
#include <cassert>
#include "LAB3PhoneBook.cpp" // Include the header file for your PhoneBook class
...
void testLoadContactsFromFile() {
    try {
        ...
        PhoneBook phoneBook;
        phoneBook.readRecordsFromFile("Detailslab3.txt"); // Assuming the file is in the same directory
